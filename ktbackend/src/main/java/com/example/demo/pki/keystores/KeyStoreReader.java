...
public class KeyStoreReader {
    ...
    public List<Certificate> getCertificates(String keyStoreFile, String keyStorePass)
    {
    ...
    public List<X509Certificate> getX509Certificates(String keyStoreFile, String keyStorePass)
    {
